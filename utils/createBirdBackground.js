const createBirdBackground = () => {
  ...
  Bird.Tri = Bird.def(
    function (p1, p2, p3) {
      this.mainv = [p1.edit(), p2.edit(), p3.edit()];
      this.Vtxs = [p1.edit(), p2.edit(), p3.edit()];
  ...
  function draw() {
    ...
    for (var i = 0; i < 100; i++) {
      ...
      let bird = (birds[i] = new Bird.Build());
...
export default createBirdBackground;
